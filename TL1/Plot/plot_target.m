...
curDir = pwd;
folder_name = [curDir '/Predictions_Target'];
mkdir(folder_name)
...
% -------------------------------------------
model = createpde(1);
R1 = [3, 4, 0, 1, 0.5+1e-12, 0.5-1e-12, 0, 0, sqrt(3)/2, sqrt(3)/2]'; % Triangular Domain
gm = [R1];
sf = 'R1';
ns = char('R1');
ns = ns';
...
% 100 testing samples
N_data = 50;
resultFileName = ['Darcy_target.mat'];
