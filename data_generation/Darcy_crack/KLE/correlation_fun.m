...
if matvec
    ...
    switch lower(name)
        ...
        case 'spher'
            ...
            parfor i = 1:n
                point = mesh2(i,:);
                X1 = abs(mesh1-repmat(point,m,1));
                X2 = abs(mesh1-repmat(point,m,1)).^3;
                C(:,i) = x*(1 - X1*c0_1' + X2*c0_2');% exp(X*c0);
            end
            %%
    ...
    switch lower(name)
        ...
        case 's_exp'
            ...
            %%
        otherwise
            error('corr.name must be gauss, exp, s_exp, turbulent or spher');
    end
